      ...
      {isOpen && (
        <nav className="flex flex-col gap-5 p-5 pb-10">
          ...
          <ul className="flex flex-col gap-3">
            ...
            <Link
              href="/feed"
              className="text-[14px] font-[400] text-gray-900 dark:text-gray-200 flex items-center gap-5 w[90%] px-2 py-3 rounded-[15px] transition-all duration-200 hover:bg-[rgba(125,133,150,0.86)] dark:hover:bg-[rgba(38,47,66,0.86)]"
            >
              <Image
      ...
      {!isOpen && (
        <nav className="flex flex-col gap-5 p-5 pb-10">
          ...
          <ul className="flex flex-col gap-3">
            <Link
              href="/feed"
              className="text-[14px] font-[400] text-gray-900 dark:text-gray-200 flex w-fit h-fit items-center gap-5 w[90%] px-2 py-3 rounded-[15px] transition-all duration-200 hover:bg-[rgba(125,133,150,0.86)] dark:hover:bg-[rgba(38,47,66,0.86)]"
            >
              <Image
                src="/assets/Images/cover.png"
                width={50}
